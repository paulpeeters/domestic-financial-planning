...
```text
downloads/DomesticFinancialPlanning-Setup-1.0.4.0.exe
```

Plaats de optionele serverversie in:

```text
downloads/DomesticFinancialPlanning-Server-1.0.4.0.zip
```
...
```text
<deploy-root>\Packages\DomesticFinancialPlanning-Server-1.0.4.0.zip
```
...
[IO.Compression.ZipFile]::OpenRead("<deploy-root>\Packages\DomesticFinancialPlanning-Server-1.0.4.0.zip").Entries |
