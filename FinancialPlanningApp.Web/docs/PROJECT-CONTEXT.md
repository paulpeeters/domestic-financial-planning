...
- Application version is pinned through csproj assembly metadata (`Version` currently `1.0.4.0`) and shown in a shared Bootstrap "Over" modal from the main navigation.
